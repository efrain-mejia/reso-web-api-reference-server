...
public class LookupEnumFlagsTest {
  private static final Logger LOGGER = Logger.getLogger(LookupEnumFlagsTest.class.getName());

    @BeforeAll
    void setupServer() throws IOException, InterruptedException {
        LOGGER.info("=========== LookupEnumFlagsTest Test Suite Starting ===========");
    ...
    void cleanup() throws IOException, InterruptedException {
        ...
        LOGGER.info("=========== LookupEnumFlagsTest Test Suite Completed ===========");
    }
}
